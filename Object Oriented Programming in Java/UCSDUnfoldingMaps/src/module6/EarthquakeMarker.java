...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		String nearbyInformation = "There are " + countNearbyMarker + " city near this earthquake";
		...
		if (countNearbyMarker == 0) {
			pg.rect(x, y + 15, pg.textWidth(nearbyInformation) +6, 18, 5);
		} 
		else {
			pg.rect(x, y + 15, Math.max(pg.textWidth(title), pg.textWidth(nearbyInformation)) + 6, 36, 5);
		}
		...
		if (countNearbyMarker != 0) {
			pg.text(nearbyInformation, x + 3, y + 36);
		}
